    ...
    return (
        <section className="bg-light dark:bg-semidark flex justify-center items-center">
            <div className="lg:max-w-screen-xl md:max-w-screen-md mx-auto container px-4">
                <h1 className="text-4xl font-bold mb-12 text-midnight_text dark:text-white" data-aos="fade-up"> {/* data-aos="fade-up" */}
                    Featured Properties
                </h1>
                ...
                {items.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {items.map((property, index) => (
                            <div key={property.id ?? index}  data-aos-delay={`${index * 100}`} data-aos="fade-up"> {/* data-aos="fade-up" */}
