...
import logoPath from '/assets/media/logo-white.png'
...
export default function Footer() {
  ...
  const icons = {
    facebook: (
      <svg width="16" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-4 px-4 sm:px-0">
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <div className="flex items-center gap-2">
                {Object.entries(pageData?.social_links || {}).map(([key, url], index) => (
                  <a
                    key={index}
                    aria-label={key}
                    href={url}
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                <li>
                  <a href="/contact" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Contact Support
                  </a>
                </li>
                <li>
                  <a href="/properties" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Properties
                  </a>
                </li>
                <li>
                  <a href="/blogs" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Blog
                  </a>
                </li>
              </ul>
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                <li onClick={() => updateFilter('category', 'apartment')}>
                  <a href="/properties?category=apartment" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Apartment for Rent
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'house')}>
                  <a href="/properties?category=house" className="mb-3 inline-block text-base text-gray hover:text-white">
                    House for Buy
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'office')}>
                  <a href="/properties?category=office" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Offices for Buy
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'shop')}>
                  <a href="/properties?category=shop" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Shop for Rent
                  </a>
                </li>
              </ul>
          ...
          <div className="lg:max-w-45 max-w-full text-center lg:text-left mb-4 lg:mb-0">
            <div className="flex lg:flex-nowrap flex-wrap lg:flex-row lg:gap-11 gap-4 text-base sm:text-lg md:text-xl text-black text-opacity-50">
              <p className="text-white">
                Phone :
                <a href={`tel:${pageData?.contact?.phone}`} className="text-gray hover:text-white"> {pageData?.contact?.phone}</a>
              </p>
              <p className="text-white">
                Email :
                <a href={`mailto:${pageData?.contact?.email}`} className="text-gray hover:text-white"> {pageData?.contact?.email}</a>
              </p>
            </div>
          </div>
