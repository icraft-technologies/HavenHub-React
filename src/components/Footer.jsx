          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-4 px-4 sm:px-0">
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                ...
                <li>
                  <a href="/properties/properties-list" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Properties
                  </a>
                </li>
                <li>
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                <li onClick={() => updateFilter('category', 'apartment')}>
                  <a href="/properties/properties-list?category=apartment" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Apartment for Rent
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'house')}>
                  <a href="/properties/properties-list?category=house" className="mb-3 inline-block text-base text-gray hover:text-white">
                    House for Buy
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'office')}>
                  <a href="/properties/properties-list?category=office" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Offices for Buy
                  </a>
                </li>
                <li onClick={() => updateFilter('category', 'shop')}>
                  <a href="/properties/properties-list?category=shop" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Shop for Rent
                  </a>
                </li>
              </ul>
          ...
          <div className="lg:max-w-45 max-w-full text-center lg:text-left mb-4 lg:mb-0">
            <div className="flex lg:flex-nowrap flex-wrap lg:flex-row lg:gap-11 gap-4 text-base sm:text-lg md:text-xl text-black text-opacity-50">
              <p className="text-white">
                Phone :
                <a href="#" className="text-gray hover:text-white"> +(690) 2560 0020</a>
              </p>
              <p className="text-white">
                Email :
                <a href="#" className="text-gray hover:text-white"> real@property.com</a>
              </p>
            </div>
          </div>
